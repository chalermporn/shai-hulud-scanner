...
export const iocPackages: IOCPackages = {
  ...
  '@asyncapi/specs': ['6.8.2', '6.9.1', '6.10.1', '6.8.3'],
  ...
  '@postman/pm-bin-macos-x64': ['1.24.3', '1.24.4'],
  ...
  'bytecode-checker-cli': ['1.0.8', '1.0.9', '1.0.10', '1.0.11'],
  'bytes-to-x': ['1.0.1'],
  ...
  'parcel-plugin-asset-copier': ['1.1.2', '.1.1.3', '1.1.3'],
  ...
  'react-scrambled-text': ['1.0.4', '1.0.5'],
  'rediff': ['1.0.5'],
  'rediff-viewer': ['0.0.7'],
  'redux-forge': ['2.5.3'],
